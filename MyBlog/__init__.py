...
from MyBlog.utils import pretty_date
...
def register_commands(app):
    ...
    @app.cli.command()
    @click.option('--category', default=0, help='分类数量,默认值为5个')
    @click.option('--post', default=0, help='文章数量,默认值为25篇')
    @click.option('--comment', default=0, help='评论数量,默认值为150个')
